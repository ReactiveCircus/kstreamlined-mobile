...
class TestFixture(
    ...
    private val applyBurstGradlePlugin: Boolean = true,
    private val applyBurstGradlePluginBeforeChameleon: Boolean = false,
                ...
                withBuildScript {
                    plugins(
                        buildList {
                            ...
                            when {
                                !applyBurstGradlePlugin -> {
                                    add(Plugins.Chameleon)
                                }

                                applyBurstGradlePluginBeforeChameleon -> {
                                    add(Plugins.Burst)
                                    add(Plugins.Chameleon)
                                }
